...
S3_DATA_SOURCE_1_PATH = "s3://etlmigration-sun/data/50-employees.csv"
#S3_DATA_SOURCE_1_PATH = r'./50-employees.csv'
S3_DATA_SOURCE_2_PATH = "s3://etlmigration-sun/data/10-name-change .csv"
#S3_DATA_SOURCE_2_PATH = r'./10-name-change .csv'
S3_DATA_OUTPUT_PATH = "s3://etlmigration-sun/output50emp/"
#S3_DATA_OUTPUT_PATH = r'./output_50emp.csv'
